...
import static de.com.android.periodical.PeriodicalDatabase.DayEntry.PERIOD_CONFIRMED;
import static de.com.android.periodical.PeriodicalDatabase.DayEntry.PERIOD_START;

import de.com.android.periodical.R;
...
public class MainActivityApp extends AppCompatActivity
    ...
    private void logout() {
        ...
        startActivity(new Intent( MainActivityApp.this,SignInActivity.class));
    }
    /**
