...
public class WelcomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pdsan = (Button) findViewById(R.id.pdsen);
        ...
        pdsan.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void openMainActivityPdf() {
        Intent intent = new Intent(WelcomeActivity.this, MainActivityPdf.class);
